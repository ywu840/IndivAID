...
class SeaStar(BaseImageDataset):
    ...
    SeaStar
    Reference:
        Wahltinez et al. An Open-Source General Purpose Machine Learning Framework for Individual Animal Re-Identification Using Few-Shot Learning. Methods in Ecology and Evolution, 2024.
    URL: 
